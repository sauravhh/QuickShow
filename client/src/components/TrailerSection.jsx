  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
        ...
        {dummyTrailers.map((trailer)=>(
          <div key={trailer.image} className='relative group-hover:not-hover:opacity-50 hover:-translate-y-1 duration-300 transition max-md:h-60 md:max-60 cursor-pointer' onClick={()=> setCurrentTrailer(trailer)}>
